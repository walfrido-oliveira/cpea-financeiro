<th scope="col"
    ...
    style="{{ $attributes['style'] }}" class="{{ $attributes['class'] }} cursor-pointer px-6 py-3 @if(!Str::contains($attributes['class'], ['text-center'])) text-left @endif  text-xs font-medium text-gray-500 uppercase tracking-wider">
     {!! $columnText !!}
