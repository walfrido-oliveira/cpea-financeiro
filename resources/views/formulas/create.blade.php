<x-app-layout>
    <div class="py-6 create-formulas">
                ...
                <div class="py-2 my-2 bg-white rounded-lg min-h-screen">
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        <div class="w-full px-3 mb-6 md:mb-0">
                            ...
                            <x-custom-select :options="$accountingClassifications" name="accounting_classification_id" id="accounting_classification_id" required :value="old('accounting_classification_id')"/>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        <div class="w-full px-3 mb-6 md:mb-0">
                            ...
                            <x-custom-multi-select multiple :options="$months" name="months[]" id="months" :value="old('months')"/>
                        </div>
                    </div>
